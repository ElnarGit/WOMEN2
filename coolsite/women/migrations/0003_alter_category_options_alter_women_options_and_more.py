# Generated by Django 4.0 on 2022-02-07 17:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='women',
            options={'ordering': ['time_create', 'title'], 'verbose_name': 'Извесные спортсмены', 'verbose_name_plural': 'Извесные спортсмены'},
        ),
